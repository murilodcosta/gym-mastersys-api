...
INSERT INTO matriculas (aluno_id, data_matricula, dia_vencimento, status)
VALUES (2, CURRENT_DATE - INTERVAL '60 days', 15, 'ATIVA');
...
SELECT m.id, CURRENT_DATE - INTERVAL '60 days', 120.00, CURRENT_TIMESTAMP - INTERVAL '60 days', 'PAGA'
FROM matriculas m
WHERE m.aluno_id = 1;
...
INSERT INTO faturas_matriculas (matricula_id, data_vencimento, valor, data_pagamento, status)
SELECT m.id, CURRENT_DATE - INTERVAL '30 days', 180.00, CURRENT_TIMESTAMP - INTERVAL '20 days', 'PAGA'
FROM matriculas m
WHERE m.aluno_id = 2;
